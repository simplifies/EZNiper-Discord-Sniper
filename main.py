...
{Fore.MAGENTA}                              ███████╗███████╗██║ ╚████║██║██║     ███████╗██║  ██║
 {Fore.MAGENTA}                             ╚══════╝╚══════╝╚═╝  ╚═══╝╚═╝╚═╝     ╚══════╝╚═╝  ╚═╝
――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――                                       
                                    {Fore.MAGENTA}[{Fore.WHITE}?{Fore.MAGENTA}]{Fore.WHITE} Logged User     = {Fore.WHITE} {Sniper.user.name}#{Sniper.user.discriminator}
                                    {Fore.MAGENTA}[{Fore.WHITE}?{Fore.MAGENTA}]{Fore.WHITE} Nitro Sniper    = {Fore.WHITE}  {nitro} {onaltt}
                                    {Fore.MAGENTA}[{Fore.WHITE}?{Fore.MAGENTA}]{Fore.WHITE} Giveaway Sniper = {Fore.WHITE}  {giveaway} {ddelay}
                                    {Fore.MAGENTA}[{Fore.WHITE}?{Fore.MAGENTA}]{Fore.WHITE} Privnote Sniper = {Fore.WHITE} {privnote}
                                    {Fore.MAGENTA}[{Fore.WHITE}?{Fore.MAGENTA}]{Fore.WHITE} Windows Notification = {Fore.WHITE} {notify}{Fore.RESET}
{Fore.MAGENTA}――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
...
def Init():
    ...
    if config.get('token') == "token-here":
        ...
        try:
            ...
            os.system(f'title EZNiper | Discord Sniper')
                            ...
                            if webhooknotification:
                                data = {
                                    "embeds": [{
                                        ...
                                        "color": 16732345,
                                        "footer": {
                                        "text": f"EZNiper | {Sniper.user.name}#{Sniper.user.discriminator} | Made by bte#0800"
                                        },
                                        "image": {
                                        "url": "https://i.imgur.com/QCsKGeF.jpg"
                                        }
                                        }],
                                        "username": "EZNiper | Discord Sniper | Nitro Sniper",
                                        "avatar_url": "https://i.imgur.com/QCsKGeF.jpg"
                                        }
                    ...
                    if webhooknotification:
                        data = {
                            "embeds": [{
                                ...
                                "url": "https://github.com/1669z",
                                "color": 16732345,
                                "footer": {
                                "text": "EZNiper | Discord Sniper | Giveaway Sniper"
                                },
                                "image": {
                                "url": "https://i.imgur.com/QCsKGeF.jpg"
                                }
...
async def on_connect():
    Clear()
    codestart()
    ctypes.windll.kernel32.SetConsoleTitleW(f'EZNiper v1.0 | Logged in as : {Sniper.user} | Made by bte#0800')
Init()
